...
BEGIN
    ...
    BEGIN
        ...
        EXECUTE format($sql$
            ...
            LEFT JOIN %I.%I ri ON ri.cd_ref = $4 AND ri.id_nomenclature_obs_technique = coalesce(s.id_nomenclature_obs_technique,58) and ri.code_territoire = $2 
        ...
        INTO
            ...
            v_result.details
        USING
            p_id_synthese, p_code_territoire, p_code_liste, v_cd_ref;
